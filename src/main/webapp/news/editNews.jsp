    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active home"><a href="${pageContext.request.contextPath}/news/postnews.jsp" class="dropdown-toggle" data-toggle="dropdown">News</a>
                    <ul class="dropdown-menu">
...
<div class="jumbotron" style="background-color:#E6E6E6;color:black;margin-top:0px;margin-bottom:0px;">
    <h1 style="font-size:40px;color:purple;text-align:center"><em>Edit News</em></h1>
</div>
    ...
    <form style="padding-left:200px;padding-top:50px;padding-right:200px;padding-bottom:50px;"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="InputBookName" placeholder="Title" name="title"
                   required = "required" pattern=".{1,50}" value="<%=news.getTitle()%>">
        </div>
        <div class="form-group">
            <label for="Content">Content</label>
            <textarea class="form-control" rows="10" id="Content" name="content" required = "required"><%=news.getContent()%></textarea>
        </div>
